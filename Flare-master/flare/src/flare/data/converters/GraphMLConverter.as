package flare.data.converters
{
	...
	{    
		 ...
		 * @param graphml the XML object containing GraphML markup schema information)
		 * @return the parsed DataSet instance
 		 * @param dataSchema
		 */
		public function parse(graphml:XML, dataSchema:DataSchema=null):DataSet
		{
			var lookup:Object = {};
			...
			var schema:DataSchema = dataSchema;
