...
{
	import com.adobe.serialization.json.JSON_CommonLib;
	...
	public class JSONConverter implements IDataConverter
	{
		...
		{
			var json:Object = JSON_CommonLib.decode(text) as Object;
		...
		public function write(data:DataSet, output:IDataOutput=null):IDataOutput
		{
			...
			output.writeUTFBytes(JSON_CommonLib.encode(tuples));
			return output;
		}
