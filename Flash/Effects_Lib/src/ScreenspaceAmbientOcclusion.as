// forked from hacker_iqf76yye's forked from: Screen Space Ambient Occlusion
...
package {
	...
	public class ScreenspaceAmbientOcclusion extends Sprite {
		...
		// entry point
		function ScreenspaceAmbientOcclusion() {
			stage.quality = "low";
