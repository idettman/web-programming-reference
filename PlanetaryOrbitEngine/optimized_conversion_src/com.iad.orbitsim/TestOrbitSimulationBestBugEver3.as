package com.iad.orbitsim
{
	...
	public class TestOrbitSimulationBestBugEver3 extends Sprite
	{
		...
		private const SCALE_MULTIPLIER:Number = 5000;
		...
		private function initOrbitSimulation ():void
		{
			...
			var timestepIncrement:Number = 1;
			...
			for (var i:int = 0; i < planetaryBodyList.length; ++i)
			{
				...
				sphereMesh = new Mesh (new SphereGeometry (20+planetaryBodyList[i].radius * SCALE_MULTIPLIER, 32,24), new ColorMaterial(planetaryBodyList[i].color));
